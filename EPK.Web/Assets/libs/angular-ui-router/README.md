...
**[EPK](http://angular-ui.github.io/ui-router/site) |**
...
[`$route` service](http://docs.angularjs.org/EPK/ngRoute.$route) in the Angular ngRoute module, which is organized around URL
...
-
**Note:** *UI-Router is under active development. As such, while this library is well-tested, the EPK may change. Consider using it in production applications only if you're comfortable following a changelog and updating your usage accordingly.*
...
* [EPK Reference](http://angular-ui.github.io/ui-router/site)
