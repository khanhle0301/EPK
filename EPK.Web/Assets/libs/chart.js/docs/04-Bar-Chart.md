...
scales | Object | - | -
*scales*.xAxes | Array |  | The bar chart officially supports only 1 x-axis but uses an array to keep the EPK consistent. Use a scatter chart if you need multiple x axes.
*Options for xAxes* | | |
